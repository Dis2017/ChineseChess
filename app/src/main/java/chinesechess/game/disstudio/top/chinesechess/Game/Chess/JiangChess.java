...
public class JiangChess extends Chess {

    public JiangChess(int gameType, int step, int borderWidth) {
        super(R.drawable.black_jiang, Chess.TYPE_BLACK, gameType, gameType == Chess.TYPE_BLACK ? new Point(4, 9) : new Point(4, 0), step, borderWidth);
    }
    ...
    public LineList getActionableLines(ChessList chessList) {
        ...
        while (true) {
            ...
            if (chess != null || (y < 0 || y > 9)) {
                if (chess instanceof ShuaiChess) {
